...
import { MainBody, MainContainer, MainHtmlContainer, ContentContainer, LogoMacho, TextContainer, HeinoImg, BljatImg, RovinImg, ButtonLink, ContentHeader, ChangingContentText, MainText, SubHeader, MainTextContainer } from './MainPageElements'
...
function MainPage() {
  return (
    <MainHtmlContainer> 
        <Helmet>
                <style>{'body { background: linear-gradient(#DA09FF, #52109A) no-repeat center center fixed; overflow: hidden; width: 100%; height: 100%; margin: 0; position: absolute; top: 0; left: 0;}'}</style>
        </Helmet>
        <MainBody>
            <MainContainer>
                ...
                <ContentContainer>
                    <TextContainer>
                      <ContentHeader>KEEMIALABOR</ContentHeader>
                      <ChangingContentText>
                        <SubHeader>Meil on pakkuda</SubHeader>
                        <Typical
